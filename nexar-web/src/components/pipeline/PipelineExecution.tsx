              ...
              {isQuantum ? (
                <>
                  <div className="text-sm text-ink-muted">
                    Your code will be submitted to <Badge variant="quantum">IBM Quantum</Badge> via the Qiskit Runtime. The code must
                    define a <code className="bg-surface-1 px-1.5 py-0.5 font-mono text-xs">circuit</code> variable (QuantumCircuit).
                  </div>
