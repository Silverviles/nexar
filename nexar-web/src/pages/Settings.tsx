import { Sliders, Server, Shield, Save, Bell } from 'lucide-react'
        ...
        <Card variant="glass">
          ...
          <CardContent className="space-y-6">
            <div className="space-y-2">
              ...
              <p className="text-xs text-ink-muted">Decisions below this threshold will require manual review</p>
            </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-ink-muted">Automatically execute decisions above 90% confidence</p>
              </div>
              <Switch />
            </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-ink-muted">Fall back to hybrid execution if quantum fails</p>
              </div>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-ink-muted">Reserve dedicated hardware slots</p>
              </div>
              <Switch />
            </div>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-ink-muted">Notify when jobs finish</p>
              </div>
              <Switch defaultChecked />
            </div>
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-ink-muted">Alert on job failures</p>
              </div>
              <Switch defaultChecked />
            </div>
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-ink-muted">Spending threshold warnings</p>
              </div>
              <Switch defaultChecked />
            </div>
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-ink-muted">Scheduled downtime notices</p>
              </div>
              <Switch defaultChecked />
            </div>
          </CardContent>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-ink-muted">Add extra security layer</p>
              </div>
              <Switch />
            </div>
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-ink-muted">Auto-logout after inactivity</p>
              </div>
