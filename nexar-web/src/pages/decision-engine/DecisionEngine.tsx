...
import { decisionEngineService, getProblemTypeLabel, getTimeComplexityLabel, fieldDescriptions } from '@/services/decision-engine-service'
      ...
      <div className="mx-auto max-w-4xl">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Enter the characteristics of your computational problem to receive optimal hardware recommendations</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              <TooltipProvider>
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Info className="h-4 w-4 text-ink-subtle cursor-help" />
                      </TooltipTrigger>
                  ...
                  <Select value={formData.problem_type} onValueChange={(value) => handleInputChange('problem_type', value as ProblemType)}>
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
