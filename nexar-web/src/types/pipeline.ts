...
export type PipelineStatus = 'processing' | 'analyzing' | 'deciding' | 'completed' | 'partial' | 'failed'
...
export type PipelineStage = 'idle' | 'processing' | 'analyzing' | 'deciding' | 'complete' | 'error'
